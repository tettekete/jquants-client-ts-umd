/*
# 決算発表予定日(/fins/announcement) API Sample
...
```sh
$ cd example
$ ts-node api-finsAnnouncement.ts
```
...
(async ()=>{
	...
	if( r.ok )
	{
		...
		//
		// import {isFinsAnnouncementResponse} from '../src/type-guard';
		// if( r.ok && isFinsAnnouncementResponse( r.data ) )
		// {
		// 	console.log( r.data.announcement[0].Code );
		// }
	}
	else
	{
