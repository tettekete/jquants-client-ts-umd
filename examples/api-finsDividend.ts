/*
# 配当金情報(/fins/dividend) API Sample
...
(async ()=>{
	...
	{
		// r.data is inferred as FinsDividendResponse,
		// so you can access properties like r.data.dividend[0].Code
		...
		//
		// import {isFinsDividendResponse} from '../src/type-guard';
		// if( r.ok && isFinsDividendResponse( r.data ) )
		// {
		// 	console.log( r.data.dividend[0].Code );
		// }
	}
	else
	{
