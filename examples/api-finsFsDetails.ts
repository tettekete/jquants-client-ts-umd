/*
# 財務諸表(BS/PL)(/fins/fs_details) API Sample
...
(async ()=>{
	...
	{
		// r.data is inferred as FinsFsDetailsResponse,
		// so you can access properties like r.data.fs_details[0].LocalCode
		...
		//
		// import {isFinsFsDetailsResponse} from '../src/type-guard';
		// if( r.ok && isFinsFsDetailsResponse( r.data ) )
		// {
		// 	console.log( r.data.fs_details[0].LocalCode );
		// }
	}
	else
	{
