...
(async ()=>{
	...
	{
		// r.data is inferred as IndicesResponse,
		// so you can access properties like r.data.indices[0].Close
		...
		//
		// import {isIndicesResponse} from '../src/type-guard';
		// if( r.ok && isIndicesResponse( r.data ) )
		// {
		// 	console.log( r.data.indices[0].Close );
		// }
	}
	else
	{
