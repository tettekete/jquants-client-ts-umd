/*
# 信用取引週末残高(/markets/weekly_margin_interest) API Sample
...
```sh
$ cd example
$ ts-node api-marketsWeeklyMarginInterest.ts
```
...
(async ()=>{
	...
	if( Result.isSuccess( r ) )
	{
		...
		//
		// import {isMarketsWeeklyMarginInterestResponse} from '../src/type-guard';
		// if( r.ok && isMarketsWeeklyMarginInterestResponse( r.data ) )
		// {
		// 	console.log( r.data.weekly_margin_interest[0].EndDate );
		// }
	}
	else
	{
